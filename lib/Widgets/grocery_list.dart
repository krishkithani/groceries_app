...
class _GroceryListState extends State<GroceryList> {
  ...
  void _loadItems() async {
    final url = Uri.https('flutter-project-99ae7-default-rtdb.firebaseio.com',
      'grocery_list.json',
    );
  ...
  void _removeItem(GroceryItem item) async {
    ...
    final url = Uri.https(
        'flutter-project-99ae7-default-rtdb.firebaseio.com/grocery_list/${item.id}.json');
